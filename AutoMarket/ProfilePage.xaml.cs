...
public partial class ProfilePage : ContentPage
{
    ...
    private async void OnSettingsTapped(object sender, TappedEventArgs e)
    {
        try
        {
            // 👇 Використовуй nameof() замість просто тексту "ProfileEdit".
            // Це гарантує, що клас не буде видалено оптимізатором.
            await Shell.Current.GoToAsync(nameof(ProfileEdit));
        }
        catch (Exception ex)
        {
            // Тепер замість вильоту ти побачиш, що саме не так
            await DisplayAlert("Помилка навігації", ex.Message, "OK");
        }
    }
