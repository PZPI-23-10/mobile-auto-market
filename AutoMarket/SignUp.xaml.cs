...
public partial class SignUp : ContentPage
{
    ...
    private void OnPasswordTextChanged(object sender, TextChangedEventArgs e)
    {
        ...
        // 1. Довжина
        bool isLengthValid = password.Length >= 8; // Краще 8 символів для безпеки
        LengthRequirementLabel.TextColor = isLengthValid ? validColor : invalidColor;
        LengthCheckmark.Opacity = isLengthValid ? 1.0 : 0.5;
        ...
        // Тут можна додати візуалізацію для спец. символу, якщо додаси Label у XAML
    }
        ...
        try
        {
            ...
            if (errorResult == null)
            {
                ...
                else
                {
                   ...
                   /* Application.Current.MainPage = new NavigationPage(new EmailLoginPage());*/
                }
            }
            else
            {
